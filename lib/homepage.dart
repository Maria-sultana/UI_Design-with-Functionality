                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: Colors.grey,
                      image: DecorationImage(image: NetworkImage("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJXOD7VwChyL2b9dCsLcouyUj23YQi_RWvOQ&usqp=CAU"),
                      fit: BoxFit.fill),
                     ),
                  ),
                  SizedBox(width: 10,),
                  Padding(
                    ...
                    child: Column(
                      children: [
                        Text("AKG N700NCM2 Wireless\n Headphones",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 14),),
                     
                      Text("199.0(4.00 Tax)",style:TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 14) ,),
                      SizedBox(height: 10,),
                      Row(
                        children: [
                          Padding(
                          ...
                          Text("1",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12),),
                       Padding(
                        padding: const EdgeInsets.only(right: 100),
                        child: Container(
          ...
          Padding(
            ...
            child: Column(
              children: [
                Column(
                  children: [
                    Text("Delivery Location",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 18))
                  ],
                ),
                SizedBox(height: 10,),
               Row(
                ...
                SizedBox(width: 30,),
                Text("53/15,North Manikdi,Dhaka Cantonment",
               ...
               Padding(
                 ...
                 child: Column(
                  ...
                  children: [
                    Text("Order Info",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.black),)
                  ],
